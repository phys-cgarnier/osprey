...
ax.plot(times, theoretical, '--', linewidth=2.5, color='#555555',
        label='Setpoint (150 A)', alpha=0.8, zorder=1)
...
ax.set_title('Focusing Quadrupole Q4F2 - Current Stability Analysis',
...
props = {'boxstyle': 'round', 'facecolor': 'wheat', 'alpha': 0.8, 'edgecolor': 'black', 'linewidth': 1}
