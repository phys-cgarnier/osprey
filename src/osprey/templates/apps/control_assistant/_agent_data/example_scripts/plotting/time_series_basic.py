...
bpm_positions = {
    ...
    'BPM02': 0.3 + 0.1 * np.sin(2 * np.pi * np.arange(24) / 12 + 0.5) + np.random.normal(0, 0.02, 24),
    'BPM03': -0.2 + 0.1 * np.sin(2 * np.pi * np.arange(24) / 12 + 1.0) + np.random.normal(0, 0.02, 24),
    'BPM04': 0.1 + 0.1 * np.sin(2 * np.pi * np.arange(24) / 12 + 1.5) + np.random.normal(0, 0.02, 24),
    'BPM05': -0.4 + 0.1 * np.sin(2 * np.pi * np.arange(24) / 12 + 2.0) + np.random.normal(0, 0.02, 24),
}
...
for idx, (channel_name, position_data) in enumerate(bpm_positions.items()):
    ax.plot(times, position_data, 'o-', linewidth=2, markersize=3,
            label=channel_name, color=colors[idx], alpha=0.8)
